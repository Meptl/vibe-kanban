        ...
        <TaskCardHeader
          ...
          right={
            <>
              ...
              <ActionsDropdown
                task={task}
                triggerClassName="h-6 w-4 rounded-sm opacity-0 transition-[opacity,background-color,color] group-hover:opacity-100 focus-visible:opacity-100 data-[state=open]:opacity-100 hover:bg-foreground/10 hover:text-foreground focus-visible:ring-0 focus-visible:ring-offset-0"
              />
            </>
          }
        />

...
export type Task = { id: string, project_id: string, title: string, description: string | null, status: TaskStatus, origin: TaskOrigin, parent_task_attempt: string | null, pinned: boolean, created_at: string, updated_at: string, };

export type TaskWithAttemptStatus = { has_in_progress_attempt: boolean, has_merged_attempt: boolean, last_attempt_failed: boolean, executor: string, id: string, project_id: string, title: string, description: string | null, status: TaskStatus, origin: TaskOrigin, parent_task_attempt: string | null, pinned: boolean, created_at: string, updated_at: string, };

export type TaskRelationships = { parent_task: Task | null, current_attempt: TaskAttempt, children: Array<Task>, };

export type CreateTask = { project_id: string, title: string, description: string | null, status: TaskStatus | null, origin: TaskOrigin | null, parent_task_attempt: string | null, image_ids: Array<string> | null, };

...
Each step uses the appropriate MCP tool (`list_projects`, `list_tasks`, `create_task`, `create_attempt`) to manage the complete workflow from planning to execution.
